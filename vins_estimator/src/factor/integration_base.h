...
class IntegrationBase
{
  public:
    ...
    // todo(znn) new constructor with encoder
    IntegrationBase (const Eigen::Vector3d &_acc_0, const Eigen::Vector3d &_gyr_0,
                     const Eigen::Vector3d &_linearized_ba, const Eigen::Vector3d &_linearized_bg,
    ...
    //todo(znn) add push_back of encoder
...
/*         if(is_stop)
        {   
            ...
            result_delta_v = Eigen::Vector3d::Zero();
        } */
    ...
    //todo(znn) add midPointIntergration with encoder
    void midPointIntegration(double _dt,
                            ...
                            bool update_jacobian)
    {
        ...
        if(update_jacobian)
        {
            ...
            V.block<3, 3>(9, 3) = 0.25 * -result_delta_q.toRotationMatrix() * R_e_1_x * _dt * _dt; // Ïà²î-
    ...
    //todo(znn) add propagate with encoder
    ...
    //todo(znn) add evaluate with encoder
    ...
    //todo(znn) add variable of encoder
